...
erpnext_ai.pages.AIChat = class AIChat {
	...
	_buildLayout() {
		const styles = `
			:root {
				--ai-chat-app-bg: #f5f7fb;
				--ai-chat-feed-bg: #f8faff;
				--ai-chat-panel: rgba(255, 255, 255, 0.82);
				--ai-chat-border: rgba(207, 217, 228, 0.7);
				--ai-chat-text: #1f2937;
				--ai-chat-muted: #6b7280;
				--ai-chat-assistant-bg: rgba(255, 255, 255, 0.95);
				--ai-chat-user-bg: rgba(247, 249, 255, 0.95);
				--ai-chat-user-text: #111827;
				--ai-chat-shadow: 0 24px 60px rgba(15, 23, 42, 0.16);
				--ai-chat-input-bg: #ffffff;
				--ai-chat-input-border: rgba(207, 217, 228, 0.7);
				--ai-chat-accent: #1f272f;
				--ai-chat-accent-hover: #13171d;
				--ai-chat-button-text: #f8fafc;
				--ai-chat-wrapper-bg: linear-gradient(140deg, rgba(255, 255, 255, 0.98), rgba(245, 247, 252, 0.92));
				--ai-chat-wrapper-border: rgba(207, 217, 228, 0.7);
				--ai-chat-input-shell-bg: rgba(255, 255, 255, 0.92);
				--ai-chat-input-shell-border: rgba(208, 214, 226, 0.65);
				--ai-chat-toolbar-bg: rgba(255, 255, 255, 0.95);
				--ai-chat-toolbar-border: rgba(207, 217, 228, 0.7);
				--ai-chat-toolbar-shadow: 0 12px 30px rgba(15, 23, 42, 0.12);
				--ai-chat-bubble-assistant: rgba(255, 255, 255, 0.95);
				--ai-chat-bubble-user: rgba(247, 249, 255, 0.95);
				--ai-chat-bubble-border: rgba(15, 23, 42, 0.06);
				--ai-chat-pending-bg: rgba(246, 249, 255, 0.72);
				--ai-chat-idle-filter: none;
				--ai-chat-idle-active-opacity: 1;
				--ai-chat-send-bg: #ffffff;
				--ai-chat-send-border: rgba(208, 214, 226, 0.65);
				--ai-chat-send-icon: #0f172a;
				--ai-chat-send-hover-bg: #f1f5f9;
				--ai-chat-send-hover-border: rgba(148, 163, 184, 0.6);
			}
			...
			html:is([data-theme="dark"], [data-theme-mode="dark"]) {
				...
				--ai-chat-assistant-bg: rgba(26, 28, 32, 0.5);
				--ai-chat-user-bg: rgba(23, 24, 28, 0.5);
				--ai-chat-user-text: #ffffff;
				--ai-chat-shadow: 0 24px 60px rgba(0, 0, 0, 0.55);
				...
				--ai-chat-wrapper-bg: rgba(35, 35, 35, 0.95);
				--ai-chat-wrapper-border: #363636;
				--ai-chat-input-shell-bg: rgba(20, 22, 26, 0.35);
				--ai-chat-input-shell-border: rgba(255, 255, 255, 0.06);
				--ai-chat-toolbar-bg: rgba(54, 54, 54, 0.85);
				--ai-chat-toolbar-border: #363636;
				--ai-chat-toolbar-shadow: 0 12px 28px rgba(0, 0, 0, 0.35);
				--ai-chat-bubble-assistant: rgba(26, 28, 32, 0.5);
				--ai-chat-bubble-user: rgba(23, 24, 28, 0.5);
				--ai-chat-bubble-border: rgba(255, 255, 255, 0.03);
				--ai-chat-pending-bg: rgba(26, 28, 32, 0.5);
				--ai-chat-idle-filter: saturate(0.8) brightness(1.1);
				--ai-chat-idle-active-opacity: 0.7;
				--ai-chat-send-bg: #363636;
				--ai-chat-send-border: #363636;
				--ai-chat-send-icon: #ffffff;
				--ai-chat-send-hover-bg: #4a4a4a;
				--ai-chat-send-hover-border: #4a4a4a;
			}
			...
			.ai-chat-wrapper {
				...
				display: flex;
				flex-direction: column;
				background: var(--ai-chat-wrapper-bg);
				border-radius: 22px;
				border: 1px solid var(--ai-chat-wrapper-border);
				overflow: hidden;
				position: relative;
				box-shadow: var(--ai-chat-shadow);
				backdrop-filter: blur(18px);
			...
			html:is([data-theme="dark"], [data-theme-mode="dark"]) .ai-chat-wrapper {
				border-color: var(--ai-chat-wrapper-border);
				background: var(--ai-chat-wrapper-bg);
			}
			...
			.ai-chat-idle-layer video {
				...
				filter: var(--ai-chat-idle-filter);
			}

			.ai-chat-wrapper.is-idle .ai-chat-idle-layer video {
				opacity: var(--ai-chat-idle-active-opacity);
			}
			...
			.ai-chat-bubble {
				...
				word-wrap: anywhere;
				position: relative;
				background: var(--ai-chat-bubble-assistant);
				color: var(--ai-chat-text);
			...
			.ai-chat-bubble.user {
				background: var(--ai-chat-bubble-user);
				border: 1px solid var(--ai-chat-bubble-border);
				box-shadow: none;
			...
			.ai-chat-bubble.pending {
				...
				background: var(--ai-chat-pending-bg);
				border: 1px solid var(--ai-chat-bubble-border);
			}
			...
			.ai-chat-input-shell {
				...
				border: 1px solid var(--ai-chat-input-shell-border);
				border-radius: 22px;
				padding: 0.65rem clamp(1.35rem, 4vw, 2rem);
				display: flex;
				flex-direction: column;
				gap: 0.75rem;
				box-shadow: var(--ai-chat-toolbar-shadow);
			}
			...
			.ai-chat-composer .btn-send {
				...
				border: 1px solid var(--ai-chat-send-border);
				color: var(--ai-chat-send-icon);
			...
			.ai-chat-composer .btn-send .ai-icon line {
				stroke: currentColor;
			}

			.ai-chat-composer .btn-send .ai-icon polygon {
				fill: currentColor;
			}

			html:is([data-theme="dark"], [data-theme-mode="dark"]) .ai-chat-composer .btn-send {
				background: var(--ai-chat-send-bg);
				border-color: var(--ai-chat-send-border);
				color: var(--ai-chat-send-icon);
			}
			...
			.ai-chat-composer .btn-send:focus {
				transform: translateY(-1px);
				background: var(--ai-chat-send-hover-bg);
				border-color: var(--ai-chat-send-hover-border);
			...
			.ai-chat-toolbar .btn-round {
				...
				justify-content: center;
				padding: 0;
				border: 1px solid var(--ai-chat-toolbar-border);
				background: var(--ai-chat-toolbar-bg);
				color: var(--ai-chat-text);
				box-shadow: var(--ai-chat-toolbar-shadow);
			...
			html:is([data-theme="dark"], [data-theme-mode="dark"]) .ai-chat-toolbar .btn-round {
				background: var(--ai-chat-toolbar-bg);
				border-color: var(--ai-chat-toolbar-border);
				color: var(--ai-chat-text);
				box-shadow: var(--ai-chat-toolbar-shadow);
			}
		...
		const resolveAssetUrl = (path) => (frappe.utils && frappe.utils.get_url)
			? frappe.utils.get_url(path)
			: path;

		this.idleVideoSources = {
			dark: resolveAssetUrl("/assets/erpnext_ai/videos/suv.MP4"),
			light: resolveAssetUrl("/assets/erpnext_ai/videos/1HMHJ9dmMzmkXg.mp4"),
		};

		const idleVideoUrl = this._getIdleVideoUrl();
		...
		this._updateIdleVideoForTheme(true);
	...
	_setupThemeWatcher() {
		...
		const handleThemeChange = frappe.utils.debounce
			? frappe.utils.debounce(() => this._updateIdleVideoForTheme(), 120)
			: () => this._updateIdleVideoForTheme();

		if (typeof MutationObserver !== "undefined") {
			this.themeObserver = new MutationObserver(handleThemeChange);
		...
		if (window.matchMedia) {
			try {
				...
				if (media.addEventListener) {
					media.addEventListener("change", mqHandler);
				} else if (media.addListener) {
					media.addListener(mqHandler);
				}
				this.themeMediaQuery = { media, handler: mqHandler };
			} catch (err) {
				console.warn("[AI Chat] Unable to bind prefers-color-scheme listener", err);
			}
		}
	}

	_updateIdleVideoForTheme(force = false) {
		const videoEl = this.$idleVideo && this.$idleVideo.get ? this.$idleVideo.get(0) : null;
		if (!videoEl) {
			return;
		}
		...
		const desiredUrl = this._getIdleVideoUrl();
		...
		this.idleVideoReady = false;
		this.idleVideoPrimed = false;
		sourceEl.setAttribute("src", desiredUrl);

		try {
			videoEl.load();
		} catch (err) {
			console.warn("[AI Chat] Failed to load idle video after theme change", err);
		}

		setTimeout(() => this._ensureIdleVideoPrimed(), 250);

		if (this.isIdle) {
			this._clearIdleTimer();
			this.idleTimer = setTimeout(() => this._enterIdleState(), 300);
		}
	}

	_getIdleVideoUrl() {
		const sources = this.idleVideoSources || {};
		const isDark = this._isDarkMode();
		const preferred = isDark ? sources.dark : sources.light;
		return preferred || sources.dark || Object.values(sources)[0] || "/assets/erpnext_ai/videos/suv.MP4";
	}
	...
	_isDarkMode() {
		...
		const themeCandidates = [
			root && root.getAttribute("data-theme-mode"),
		...
		const themeMatch = themeCandidates.find((value) => value.includes("dark") || value.includes("light"));
		if (themeMatch) {
			return themeMatch.includes("dark");
		}
